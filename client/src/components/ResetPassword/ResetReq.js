    ...
    <form onSubmit={handleSubmit} className={styles.container}>
      ...
      <h1 className={styles.headerText}>Reset Password</h1>
			...
			<div className={styles.instructions}>
				<p className={styles.instructionsText}>To reset your password, 
				enter your email below and submit. An email will be sent 
				to you with instructions about how to complete the process.</p>
			</div>
